                                ...
                                <div class="d-flex align-items-end">
                                    <div class="form-group mr-2 w-50">
                                        <div class="form-group mb-0 mr-3 d-inline-block">
                                            ...
                                            <input name="image_banner" accept="image/*" type="file" id="image" class="form-control-file" onchange="document.getElementById('blah2').src = window.URL.createObjectURL(this.files[0])" />
                                        </div>
                                        <img id="blah2" class="d-inline-block" src="/backend/template/images/img-1px.png" alt="your image" style="max-width: 100px;" />
                                    </div>
